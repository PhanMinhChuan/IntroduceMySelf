...
<!-- 	          images/bg_1.jpg   <%=request.getContextPath()%>/slide.jpg-->
	          	<div class="one-third order-md-last img" style="background-image:url(<%=request.getContextPath() %>/templates/public/images/OLEXS90.jpg);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	...
		          	<div class="text">
			            ...
			            <p><a href="<%=request.getContextPath() %>/templates/public/cv/PhanMinhChuan.pdf" class="btn-custom" download>Doawload CV</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            <h2 class="mb-4" style="font-size: 26px;margin-top: 35px;">Tóm tắt bản thân</h2>
		            <p>Mình là <strong>Phan Minh Chuẩn</strong>, đến từ trường đại học Bách Khoa Đà Nẵng. Mình có một năm kinh nghiệm về Java Software Engineer trong phát triển website. Mình đã từng làm các dự án về Servlet-JSP, Spring Boot,...</p>
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>Mong muốn trở thành một Web Developer, mục tiêu của mình trong 3 năm tới sẽ trở thành một Senior Java Developer.</p>
		          </div>
		        </div>
		        <!-- Button trigger modal -->
...
<!-- 				      </div> -->
						    ...
						    <div style="padding-top : 50px;padding-bottom:60px; border: 2px dashed;">
						    		<div class="row">
							          <div class="col-12 col-sm-4">
							            <img alt="" src="<%=request.getContextPath() %>/templates/public/images/anhdaidien.jpeg" style="width: 180px;height: 233px;display:block;margin-left:auto;margin-right:auto;"/>
							          </div>
							          <hr>
							          <div class="col-12 col-sm-8" style="padding-right:35px;padding-left:35px;"> 
						          		<h2>
											<%=profile.getName() %>
										</h2>
	...
	<section class="ftco-section bg-light displaynoneformobile" id="skills-section">
		<div class="container">
						...
						<div class="khoi2">
							...
							<div class="row">
								...
								<div class="col-sm-5 work55">
									<h4>Pass Japanese Language Proficiency Test</h4>
									<p>JLPT N2</p>
								</div>
							</div>
						</div>
